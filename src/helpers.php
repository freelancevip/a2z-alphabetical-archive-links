...
function get_post_a2zaal_info( $post_title ) {
	...
	preg_match( '/\A[(a|an|and|the) ]*\b(([a-zA-Zа-яА-Я]{1}|[\d]{1,}).*)\z/ui', $post_title, $a2zaal_char );
	$post_a2zaal_info = array( 'sort_title' => $a2zaal_char[1], 'initial' => mb_strtoupper( $a2zaal_char[2] ) );
